...
const RL32 = () => {
    ...
    const hitungPasienAkhirBulan = ((index) => {
        const result = (parseInt(dataRL[index].pasien_awal_bulan) +
            ...
            (parseInt(dataRL[index].pasien_dipindahkan) + parseInt(dataRL[index].pasien_keluar_hidup) +
                ...
                parseInt(dataRL[index].pasien_wanita_keluar_mati_lebih_dari_atau_sama_dengan_48_jam)
            )
        return result
    })
    ...
    const simpanValidasi = async (e) => {
        ...
        try {
            ...
            await axiosJWT.post('/apisirs6v2/validasi',{
                rsId: rumahSakit.id,
                rlId: "rl.3.2",
                periodeBulan: bulan,
                periodeTahun: tahun,
    ...
    const calculateTotalPasienWanitaKeluarMatiKurangDari48Jam = (data) => {
        return data.reduce((sum, item) => sum + item.pasien_wanita_keluar_mati_kurang_dari_48_jam, 0);
    }

    const calculateTotalPasienWanitaMatiLebihDariAtauSamaDengan48Jam = (data) => {
        return data.reduce((sum, item) => sum + item.pasien_wanita_keluar_mati_lebih_dari_atau_sama_dengan_48_jam, 0);
    }
    ...
    const calculateTotalPasienAkhirBulan = (data) => {
        return data.reduce((sum, item) => sum +
            ...
            (parseInt(item.pasien_dipindahkan) + parseInt(item.pasien_keluar_hidup) +
                ...
                parseInt(item.pasien_wanita_keluar_mati_lebih_dari_atau_sama_dengan_48_jam)
            ), 0);
    }
    ...
    const totalPasienWanitaKeluarMatiKurangDari48Jam = calculateTotalPasienWanitaKeluarMatiKurangDari48Jam(dataRL);
    const totalPasienWanitaKeluarMatiLebihDariAtauSamaDengan48Jam = calculateTotalPasienWanitaMatiLebihDariAtauSamaDengan48Jam(dataRL);
    ...
    return (
        <div className="container" style={{ marginTop: "70px", marginBottom: "70px" }}>
            ...
            <Modal show={showValidasi} onHide={handleCloseValidasi} style={{ position: "fixed" }}>
                <Modal.Header closeButton>
                ...
                <form onSubmit={simpanValidasi}>
                    <Modal.Body>
                        ...
                        <div className="form-floating" style={{ width: "100%", paddingBottom: "5px" }}>
                            <input type='text' id="keteranganValidasi" name='keterangansValidasi' className="form-control" onChange={e => keteranganValidasiChangeHadler(e)} />
                    ...
                    <Modal.Footer>
                        <div className="mt-1 mb-1">
                            <ToastContainer />
                            <button type="submit" className="btn btn-outline-success"><HiSaveAs size={20} /> Simpan</button>
                        </div>
                    </Modal.Footer>
                </form>
            </Modal>
                    ...
                    <div>
                        ...
                        <div className="tab-content mt-3">
                                    ...
                                    >
                                        <thead className={style.thead}>
                                            <tr className="">
                                                ...
                                                <th className={style['sticky-header']} rowSpan="2" style={{ "width": "5%" }}>Aksi</th>
                                            ...
                                            {dataRL.map((value, index) => {
                                                return (
                                                    <tr key={value.id}>
                                                        ...
                                                        <td><input type="text" name="wanitaKurangDari48Jam" className="form-control" value={value.pasien_wanita_keluar_mati_kurang_dari_48_jam}
                                                            disabled={true} />
                                                        </td>
                                                        <td><input type="text" name="wanitaLebihDariAtauSamaDengan48Jam" className="form-control" value={value.pasien_wanita_keluar_mati_lebih_dari_atau_sama_dengan_48_jam}
                                                            disabled={true} />
                                                        </td>
                                                    ...
                                                    <>
                                                        <tr>
                                                            ...
                                                            <td><input type="text" name="totalPasienKeluarMatiLebihDariAtauSamaDengan48Jam" className="form-control" value={totalPasienKeluarMatiLebihDariAtauSamaDengan48Jam}
                                                                disabled={true} /></td>
                                                            <td><input type="text" name="totalPasienWanitaKeluarMatiKurangDari48Jam" className="form-control" value={totalPasienWanitaKeluarMatiKurangDari48Jam}
                                                                disabled={true} /></td>
                                                            <td><input type="text" name="totalPasienWanitaKeluarMatiLebihDariAtauSamaDengan48Jam" className="form-control" value={totalPasienWanitaKeluarMatiLebihDariAtauSamaDengan48Jam}
                                                                disabled={true} /></td>
                            ...
                            <div className={`tab-pane fade ${activeTab === 'tab2' ? 'show active' : ''}`}>
                                <button className='btn mb-1' style={{ fontSize: "18px", backgroundColor: "#779D9E", color: "#FFFFFF" }} onClick={handleShowValidasi}>
                                    +
                                </button>
                                <div className={style['table-container']}>
                                    <table
                                        className={style.table} style={ { width: "100%"}}
                                    >
                                        <thead className={style.thead}>
                                            <tr className="">
                                                ...
                                                <th rowSpan="2" style={{ "width": "3%" }}>Created At</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
