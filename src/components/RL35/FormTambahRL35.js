...
const FormTambahRL35 = () => {
    ...
    const changeHandler = (event, index) => {
        ...
        if (name === 'check') {
            ...
            newDataRL[index].kunjungan_pasien_dalam_kabkota_laki = parseInt(event.target.value)
            newDataRL[index].total_kunjungan = parseInt(event.target.value) + parseInt(dataRL[index].kunjungan_pasien_dalam_kabkota_perempuan) + parseInt(dataRL[index].kunjungan_pasien_luar_kabkota_laki) + parseInt(dataRL[index].kunjungan_pasien_luar_kabkota_perempuan)
            ...
            newDataRL[index].kunjungan_pasien_dalam_kabkota_perempuan = parseInt(event.target.value)
            newDataRL[index].total_kunjungan = parseInt(event.target.value) + parseInt(dataRL[index].kunjungan_pasien_dalam_kabkota_laki) + parseInt(dataRL[index].kunjungan_pasien_luar_kabkota_laki) + parseInt(dataRL[index].kunjungan_pasien_luar_kabkota_perempuan)
            ...
            newDataRL[index].kunjungan_pasien_luar_kabkota_laki = parseInt(event.target.value)
            newDataRL[index].total_kunjungan = parseInt(event.target.value) + parseInt(dataRL[index].kunjungan_pasien_dalam_kabkota_perempuan) + parseInt(dataRL[index].kunjungan_pasien_dalam_kabkota_laki) + parseInt(dataRL[index].kunjungan_pasien_luar_kabkota_perempuan)
            ...
            newDataRL[index].kunjungan_pasien_luar_kabkota_perempuan = parseInt(event.target.value)
            newDataRL[index].total_kunjungan = parseInt(event.target.value) + parseInt(dataRL[index].kunjungan_pasien_dalam_kabkota_perempuan) + parseInt(dataRL[index].kunjungan_pasien_luar_kabkota_laki) + parseInt(dataRL[index].kunjungan_pasien_dalam_kabkota_laki)
        }
        ...
        jumlahDataRL[34].total_kunjungan = Math.ceil(jumlahDataRL[34].total_kunjungan/4)
                                ...
                                {dataRL.map((value, index) => {
                                    ...
                                    return (
                                        <tr key={value.id}>
                                            ...
                                            <td>
                                                <input type="number" min={value.min} onFocus={handleFocus} maxLength={7} onInput={(e) => maxLengthCheck(e)} name="kunjungan_pasien_dalam_kabkota_laki" className="form-control" value={value.kunjungan_pasien_dalam_kabkota_laki}
                                                    onChange={e => changeHandler(e, index)} disabled={value.disabledInput} onPaste={preventPasteNegative} onKeyPress={preventMinus} />
                                            </td>
                                            <td>
                                                <input type="number" min={value.min} onFocus={handleFocus} maxLength={7} onInput={(e) => maxLengthCheck(e)} name="kunjungan_pasien_dalam_kabkota_perempuan" className="form-control" value={value.kunjungan_pasien_dalam_kabkota_perempuan}
                                                    onChange={e => changeHandler(e, index)} disabled={value.disabledInput} onPaste={preventPasteNegative} onKeyPress={preventMinus} />
                                            </td>
                                            <td>
                                                <input type="number" min={value.min} onFocus={handleFocus} maxLength={7} onInput={(e) => maxLengthCheck(e)} name="kunjungan_pasien_luar_kabkota_laki" className="form-control" value={value.kunjungan_pasien_luar_kabkota_laki}
                                                    onChange={e => changeHandler(e, index)} disabled={value.disabledInput} onPaste={preventPasteNegative} onKeyPress={preventMinus} />
                                            </td>
                                            <td>
                                                <input type="number" min={value.min} onFocus={handleFocus} maxLength={7} onInput={(e) => maxLengthCheck(e)} name="kunjungan_pasien_luar_kabkota_perempuan" className="form-control" value={value.kunjungan_pasien_luar_kabkota_perempuan}
                                                    onChange={e => changeHandler(e, index)} disabled={value.disabledInput} onPaste={preventPasteNegative} onKeyPress={preventMinus} />
                                            </td>
                                            <td>
                                                <input type="number" min={value.min} onFocus={handleFocus} maxLength={7} onInput={(e) => maxLengthCheck(e)} name="total_kunjungan" className="form-control" value={value.total_kunjungan}
